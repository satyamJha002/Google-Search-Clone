const SearchedImageItemTemplate = ({ data }) => {
  return (
    ...
    >
      <div className="rounded-xl overflow-hidden bg-black/[0.05] h-[100px] md:h-[120px] lg:h-[140px] group-hover:shadow-c">
        <img src={data.link} alt="img" className="w-full h-full object-cover" />
      </div>
